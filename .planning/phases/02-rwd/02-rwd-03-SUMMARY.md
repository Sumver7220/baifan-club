...
One-liner: Added explicit aspect-ratio constraints on major gallery/menu/staff image surfaces to stabilize rendering across breakpoints.
...
- SCSS search shows `aspect-ratio` now defined on key surfaces:
  - clerk cards and modal image
  - service gallery cards
  - menu poster and cards
  - moment gallery cards
  - environment cards
...
- Modified files exist and compile successfully.

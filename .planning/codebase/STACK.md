...
- Native CSS features - custom properties, \ackdrop-filter\, \100dvh\, flexbox, grid, and media queries across \css/*.scss\
- Local font files - bundled in \ssets/fonts/\ and declared in \css/base.scss\

**Infrastructure:**

- Local image assets - bundled in \ssets/images/\ and referenced from \index.html\ and page styles
...
- Fonts are loaded with \@font-face\ from \ssets/fonts/\ in \css/base.scss\
...
- A browser that supports modern CSS layout and \	ouch*\ events
